...
public sealed record SkinInput(string Weapon, int PaintKit, float Wear, int Seed);
...
public sealed record CollectionInput(string Name, IReadOnlyList<SkinInput>? Skins = null);
